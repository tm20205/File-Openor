 ...
 namespace WindowsFormsApp1
 {
  static class Program
  {
    ...
    static void Main()
    {
      ...
      int dysplaytime = Convert.ToInt32(debuglist[1]);
      ...
      if (Looptime == 0)
      {
            if (WindowName1 != @"null")
            {
              ...
              Console.WriteLine("Window1 is moved.");
            }
          ...
          if (WindowName2 != @"null")
          {
            ...
            Console.WriteLine("Window2 is moved.");
          }
          ...
          if (WindowName3 != @"null")
          {
            ...
            Console.WriteLine("Window3 is moved.");
          }
          ...
          if (WindowName4 != @"null")
          {
            ...
            Console.WriteLine("Window4 is moved.");
          }
          ...
          if (WindowName5 != @"null")
          {
            ...
            Console.WriteLine("Window5 is moved.");
          }
          ...
          if (WindowName6 != @"null")
          {
            ...
            Console.WriteLine("Window6 is moved.");
          }
          ...
          if (WindowName7 != @"null")
          {
            ...
            Console.WriteLine("Window7 is moved.");
          }
          ...
          if (WindowName8 != @"null")
          {
            ...
            Console.WriteLine("Window8 is moved.");
          }
      ...
      else if (Looptime != 0)
      {
        while (true)
        {
          ...
          if (count1 == 1 && WNcount1 == 0)
          {
            ...
            Console.WriteLine(WindowName1 + @" hWnd is " + hWnd1bS);
            Console.WriteLine(WindowName1 + " TOPMOST result is "+ WT1checkTOP);
            Console.WriteLine(WindowName1 + " NOTOPMOST result is " + WT1checkNOTOP);
            if (WT1checkTOP && WT1checkNOTOP)
            {
              Console.WriteLine(WindowName1 + " is TopMost.");
              WNcount1 = 1;
            }
          }
          if (count2 == 1 && WNcount2 == 0)
          {
            ...
            Console.WriteLine(WindowName2 + @" hWnd is " + hWnd2bS);
            Console.WriteLine(WindowName2 + " TOPMOST result is "+ WT2checkTOP);
            Console.WriteLine(WindowName2 + " NOTOPMOST result is " + WT2checkNOTOP);
            if (WT2checkTOP && WT2checkNOTOP)
            {
              Console.WriteLine(WindowName2 + " is TopMost.");
              WNcount2 = 1;
            }
          }
          if (count3 == 1 && WNcount3 == 0)
          {
            ...
            Console.WriteLine(WindowName3 + @" hWnd is " + hWnd3bS);
            Console.WriteLine(WindowName3 + " TOPMOST result is "+ WT3checkTOP);
            Console.WriteLine(WindowName3 + " NOTOPMOST result is " + WT3checkNOTOP);
            if (WT3checkTOP && WT3checkNOTOP)
            {
              Console.WriteLine(WindowName3 + " is TopMost.");
              WNcount3 = 1;
            }
          }
          if (count4 == 1 && WNcount4 == 0)
          {
            ...
            Console.WriteLine(WindowName4 + @" hWnd is " + hWnd4bS);
            Console.WriteLine(WindowName4 + " TOPMOST result is "+ WT4checkTOP);
            Console.WriteLine(WindowName4 + " NOTOPMOST result is " + WT4checkNOTOP);
            if (WT4checkTOP && WT4checkNOTOP)
            {
              Console.WriteLine(WindowName4 + " is TopMost.");
              WNcount4 = 1;
            }
          }
          if (count5 == 1 && WNcount5 == 0)
          {
            ...
            Console.WriteLine(WindowName5 + @" hWnd is " + hWnd5bS);
            Console.WriteLine(WindowName5 + " TOPMOST result is "+ WT5checkTOP);
            Console.WriteLine(WindowName5 + " NOTOPMOST result is " + WT5checkNOTOP);
            if (WT5checkTOP && WT5checkNOTOP)
            {
              Console.WriteLine(WindowName5 + " is TopMost.");
              WNcount5 = 1;
            }
          }
          if (count6 == 1 && WNcount6 == 0)
          {
            ...
            Console.WriteLine(WindowName6 + @" hWnd is " + hWnd6bS);
            Console.WriteLine(WindowName6 + " TOPMOST result is "+ WT6checkTOP);
            Console.WriteLine(WindowName6 + " NOTOPMOST result is " + WT6checkNOTOP);
            if (WT6checkTOP && WT6checkNOTOP)
            {
              Console.WriteLine(WindowName6 + " is TopMost.");
              WNcount6 = 1;
            }
          }
          if (count7 == 1 && WNcount7 == 0)
          {
            ...
            Console.WriteLine(WindowName7 + @" hWnd is " + hWnd7bS);
            Console.WriteLine(WindowName7 + " TOPMOST result is "+ WT7checkTOP);
            Console.WriteLine(WindowName7 + " NOTOPMOST result is " + WT7checkNOTOP);
            if (WT7checkTOP && WT7checkNOTOP)
            {
              Console.WriteLine(WindowName7 + " is TopMost.");
              WNcount7 = 1;
            }
          }
          if (count8 == 1 && WNcount8 == 0)
          {
            ...
            Console.WriteLine(WindowName8 + @" hWnd is " + hWnd8bS);
            Console.WriteLine(WindowName8 + " TOPMOST result is "+ WT8checkTOP);
            Console.WriteLine(WindowName8 + " NOTOPMOST result is " + WT8checkNOTOP);
            if (WT8checkTOP && WT8checkNOTOP)
            {
              Console.WriteLine(WindowName8 + " is TopMost.");
              WNcount8 = 1;
            }
          }
